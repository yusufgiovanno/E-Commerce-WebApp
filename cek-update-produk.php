...
<?php				
	if ($_POST['edit'] == "edit") {
		...
		if ($nama != ""){
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1044070){
				    ...
				    $update = mysqli_query($conn, "UPDATE products SET ProductID='$ProductID', ProductName='$ProductName', RemarkProduct='$RemarkProduct',  
		                                  CategoryID='$CategoryID', QuantityPerUnit='$QuantityPerUnit', SalePrice='$SalePrice', UnitPrice='$UnitPrice', Discon='$Discon', 
		                                  UnitsInStock='$UnitsInStock', MinStock='$MinStock', ReorderLevel='$ReorderLevel', ExpiredDate='$ExpiredDate',  
		                                  SatuanTerkecil='n', Picture='$nama' WHERE ProductID='$ProductID'");
    				if ($update) {
            			echo "
		...
		}else
		{
		    $update = mysqli_query($conn, "UPDATE products SET ProductID='$ProductID', ProductName='$ProductName', RemarkProduct='$RemarkProduct',  
		                                  CategoryID='$CategoryID', QuantityPerUnit='$QuantityPerUnit', SalePrice='$SalePrice', UnitPrice='$UnitPrice', Discon='$Discon', 
		                                  UnitsInStock='$UnitsInStock', MinStock='$MinStock', ReorderLevel='$ReorderLevel', ExpiredDate='$ExpiredDate', Discontinued='$Discontinued', 
		                                  SatuanTerkecil='$SatuanTerkecil' WHERE ProductID='$ProductID'");
    		 if($update){
    		    echo "
                    <div class='row justify-content-center'>
                      <div class='col-xl-5 col-lg-12 col-md-9'>
                            ...
                            <div class='row'>
                              <div class='col-lg-12'>
                                <div class='p-5'>
                                  ...
                                  <a href='master-update-produk.php' class='btn btn-danger btn-user btn-block'>
                                        Kembali
                                  </a> 
                                </div>
                              </div>
