	...
	if ($_POST['edit'] == "edit") {
		...
		if ($Status=='Received')
		{
			...
			/*$query1="INSERT INTO jurnal (Tanggal_Jurnal,Jenis_Jurnal,No_Bukti,No_Perkiraan,Debet_Jurnal,Kredit_Jurnal, Keterangan_Jurnal,No_Urut) VALUES
                                        (now(),'FD',$DistribusiID,CONCAT('1050.',$To_Emp),$UnitPrice*$Qty,0,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),1),
                                        (now(),'FD',$DistribusiID,CONCAT('3001.',$To_Emp),0, $UnitPrice*$Qty,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),2),
                                        (now(),'FD',$DistribusiID,CONCAT('5001.06.',$To_Emp),$UnitPrice*$Qty,0,CONCAT('Distribusi ','$Status,' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),3),
                                        (now(),'FD',$DistribusiID,CONCAT('5001.',$To_Emp),0, $UnitPrice*$Qty,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),4)";*/
			$query = mysqli_query($conn, "INSERT INTO jurnal (Tanggal_Jurnal,Jenis_Jurnal,No_Bukti,No_Perkiraan,Debet_Jurnal,Kredit_Jurnal, Keterangan_Jurnal,No_Urut) VALUES
                                        (now(),'FD',$DistribusiID,CONCAT('1050.',$To_Emp),$UnitPrice*$Qty,0,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),1),
                                        (now(),'FD',$DistribusiID,CONCAT('1401.',$To_Emp),0, $UnitPrice*$Qty,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),2),
                                        (now(),'FD',$DistribusiID,CONCAT('5001.06.',$To_Emp),$UnitPrice*$Qty,0,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),3),
                                        (now(),'FD',$DistribusiID,CONCAT('5001.',$To_Emp),0, $UnitPrice*$Qty,CONCAT('Distribusi ','$Status',' oleh -',$From_Emp,' Ke -',$To_Emp,' Produk -',$ProductID),4)"); 
                    ...
                    <div class='row'>
                      <div class='col-lg-12'>
                        <div class='p-5'>
                          ...
                          <a href='distribusi-receive.php' class='btn btn-success btn-user btn-block'>
                                Back
                          </a> 
                        </div>
                      </div>
