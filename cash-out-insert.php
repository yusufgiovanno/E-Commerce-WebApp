...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="container">
              <!-- Form -->
              <form action="cek-insert-cash-out.php" method="POST">

              <!-- Jenis Cash In -->
              <div class="row">
                <div class="col-25">
                  <label>Type of Cash Out<a style="color: red;">*</label></a>
                </div>
                <div class="col-75">
                  <select id="Type" name="Type" class="form-control">
                    <option value="">Pilih Jenis Arus Keluar Kas</option>
                    <option value="1">1 = Cost Delivery </option>
                    <option value="2">2 = Payroll </option>
                    <option value="3">3 = Listrik </option>
                  </select>
                </div>
              </div> 
              ...
              <div class="row">
                <div class="col-25">
                  <label>Bukti <a style="color: red;">*</label></a>
                </div>
                <div class="col-75">
  ...
  <script>
      $(document).ready(function () {
          $("#Type").select2({
              placeholder: "Pilih Jenis Arus Kas Keluar"
          });
      });
  </script>
