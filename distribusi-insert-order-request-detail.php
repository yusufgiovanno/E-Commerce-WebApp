...
<body id="page-top">
  ...
  include 'session.php';
    ...
    $queryDistribusi = mysqli_query($conn, "SELECT * FROM distribusi_products dp JOIN products p ON (dp.ProductID=p.ProductID) JOIN employees e ON(dp.From_Emp=e.EmployeeID) WHERE DistribusiID='$DistribusiID'") or die(mysql_error());
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="container">
              <!-- Form -->
              <form action="cek-update-order-request.php?RequestID=<?php echo $DistribusiID;?>" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="text" name="From_Emp" placeholder="Masukkan Nama Pengirim" readonly class="form-control" value="<?php echo $updateDistribusi['From_Emp'].' - '.$updateDistribusi['FirstName'].' '.$updateDistribusi['LastName'].' - '.$updateDistribusi['City'] ;?>">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="number" name="Qty" min='0' placeholder="Masukkan Jumlah Barang" readonly class="form-control" value="<?php echo $updateDistribusi['Qty'] ;?>">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <select id="Status" name="Status" class="form-control">
                    ...
                    <option value="Decline" <?php echo ($updateDistribusi['Status']=='Declain')?"selected":"";?>>Declain</option>
                  </select>
                </div>
              </div>
	        ...
	        ?>
              ...
              <div align="right">
                ...
                <a href="distribusi-insert-order-request.php?OrderID=<?php echo $OrderID;?>" class="btn btn-danger">Kembali</a>
              </div>
              </form>
            </div>
            </div>
