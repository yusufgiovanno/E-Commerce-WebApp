...
<?php			
	...
	if ($_POST['edit'] == "edit") {
		...
		$update = mysqli_query($conn, "UPDATE employees SET EmployeeID='$EmployeeID', FirstName='$FirstName', LastName='$LastName', Title='$Title', 
                        ...
                        <div class='row'>
                          <div class='col-lg-12'>
                            <div class='p-5'>
                              ...
                              <a href='master-update-pegawai.php' class='btn btn-danger btn-user btn-block'>
                                    Kembali
                              </a> 
                            </div>
                          </div>
