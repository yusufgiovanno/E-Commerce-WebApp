		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					...
					return datasetLabel + 'e: ' + number_format(tooltipItem.xLabel,0,',','.');
				}
			}
		}
	};
	...
	defaults.doughnut = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.index] + 'a: ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index];
				}
			}
		}
	};
	...
	Chart.defaults.polarArea = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.index] + 'b: ' + tooltipItem.yLabel;
				}
			}
		}
	};
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.tooltips = {
		...
		callbacks: {
			...
			label: function(tooltipItem, data) {
				var datasetLabel = data.datasets[tooltipItem.datasetIndex].label || '';
				return datasetLabel + 'c: ' + tooltipItem.yLabel;
			},
