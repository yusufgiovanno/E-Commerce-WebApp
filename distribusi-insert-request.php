      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Request Product</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add Request Product</h6>
            </div>
            
            <div class="container">
              <!-- Form -->
              <form action="cek-insert-request.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-75">
					<select id="Product" placeholder="Pilih Product" data-allow-clear="1" name="ProductID" class="form-control" required>
						<option></option>
						<?php
    						$sql = "SELECT se.ProductID, ProductName 
    						        FROM stckproductonemployee se JOIN products p ON(se.ProductID=p.ProductID) 
    						        WHERE se.Discontinued='n' AND se.EmployeeID='$eid' AND se.ProductID NOT IN(SELECT dp.ProductID FROM distribusi_products dp WHERE Status='Request' AND From_Emp='$eid') 
              ...
              <div class="row">
                  ...
                  <div class="col-75">
                      <select id="Employee" placeholder="Pilih Karyawan" data-allow-clear="1" name="EmployeeID" class="form-control">
                        <option></option>
                        <?php
                            $sql = "SELECT * FROM employees WHERE Level='2' AND EmployeeID<>'1101'";
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="number" name="Qty" min='0' placeholder="Masukkan Jumlah Barang" class="form-control">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="number" min='0' name="CostDelivery" placeholder="Masukkan Biaya Pengiriman" class="form-control">
                </div>
              </div>
             ...
             <!-- * -->
              ...
              <div align="right">
                ...
                <a href="distribusi-order.php" class="btn btn-danger">Back</a>
              </div>
              </form>
            </div>
        </div>
