      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Receive Detail</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Receive Detail</h6>
            </div>
            
            <div class="container">
              <!-- Form -->
              <form action="cek-update-receive.php?DistribusiID=<?php echo $DistribusiID;?>" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <select id="Status" name="Status" class="form-control">
                    ...
                    <option value="Received" <?php echo ($updateDistribusi['Status']=='Received')?"selected":"";?>>Received</option>
	        ...
	        ?>
              ...
              <div align="right">
                ...
                <a href="distribusi-receive.php" class="btn btn-danger">Kembali</a>
              </div>
              </form>
            </div>
            </div>
