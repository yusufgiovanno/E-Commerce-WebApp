            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Consignment</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card" style="width: 9rem; margin-right: 10px; margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="transaction-consinyasi-cart.php?id=<?php echo $ProductID[$i]; ?> &action=add" class="btn btn-info" style="float:right">Tambahkan Ke Keranjang</a>
                            </div>
                        </div>
                        <?php
                                }
