...
<?php
	...
	if ($_POST['edit'] == "edit") {
		...
		if ($Status=='ReceiveRequest'){
		    $query = mysqli_query($conn, "UPDATE distribusi_products SET Status='$Status',Receive_Date=now() WHERE DistribusiID='$RequestID'");
		}else
		{
		    $query = mysqli_query($conn, "UPDATE distribusi_products SET Status='$Status' WHERE DistribusiID='$RequestID'");
		}
                    ...
                    <div class='row'>
                      <div class='col-lg-12'>
                        <div class='p-5'>
                          ...
                          <a href='distribusi-insert-order-request.php' class='btn btn-success btn-user btn-block'>
                                Back
                          </a> 
                        </div>
                      </div>
                    ...
                    <div class='row'>
                      <div class='col-lg-12'>
                        <div class='p-5'>
                          ...
                          <a href='distribusi-insert-order-request-detail.php' class='btn btn-danger btn-user btn-block'>
                                Kembali
                          </a> 
                        </div>
                      </div>
